...
class SalereturnController extends Controller
{
    ...
    // Add this new method to handle AJAX request
    ...
    public function salereturn_list()
    {
        ...
        $suppliers = Customer::whereIn('id', $supplierIds)->get();
        $account = Account::all();
        return view('admin.salereturn.salereturnitems', compact('sales', 'suppliers', 'user', 'logo', 'account'));

    }

    public function getPrefixByCustomer(Request $request)
    {
        try {
