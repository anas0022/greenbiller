...
class PurchasePostController extends Controller
{
    public function new_purchase()
    {
        ...
        return view('store.purchase.addpurchase', compact('supplier', 'account', 'ware', 'tax', 'store', 'unit', 'logo', 'category', 'brands', 'country'));
    }
    ...
    public function add_purchase(Request $request)
    {
        ...
        if (
            ...
            return redirect()->route('invoice_purchase.view.store', ['purchase' => $purchase->id])
