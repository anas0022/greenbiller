    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="modal fade" id="import">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('supplier_ledger_import') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="col-xl-12">
                    <form action="{{route('add.su')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-header">

                                <h4 class="card-title"> Add Supplier <i class="flaticon-381-fast-forward"></i> </h4>
                                                    ...
                                                    <div class="col-lg-6 mb-2">
                                                        <div class="form-group">
                                                            <label class="form-label">Supplier Name<span
                                                                    ...
                                                                    <input type="text" name="supplier_code" class="form-control form-control-sm" readonly value="" hidden>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="opening_balance"
                                                                class="form-control form-control-sm" value="00">
                                                        </div>
                                                    </div>
                                                  {{--   
