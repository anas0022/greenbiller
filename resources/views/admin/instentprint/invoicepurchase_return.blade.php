            ...
            <div class="col-lg-12">
                <div class="card" id="preview_data" style="background-color: white;">
                    ...
                    <div style="padding:10px;" >
                        <h3 style="width: 100%; display:flex; justify-content:center;">Debit Note</h3>
                            ...
                            <div class="invoice-box">
                                ...
                                <table>
                                    <tr class="item">
                                        ...
                                        <td  style="width:80%; text-align:right; position:relative; height: 100%; display:flex; justify-content:end; ">

                                            <table style="width:100%;  position:absolute; left:30%;">
                                                <tr style="width:100%;">
                                                    <td>
