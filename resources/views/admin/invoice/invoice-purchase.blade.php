...
<td style="text-align: left; width:20%; border: 0px !important;">
    <img src="{{asset('storage/'.$store->firstWhere('id', $purchase->store_id)->logo )}}"
        style="width: 150px; height: 100px;">

</td>
<td style="width:70%; float: left; text-align: left; border: 0px !important; ">
    <h2>{{$store->firstWhere('id',$purchase->store_id)->store_name}}</h2>
    Address: {{$store->firstWhere('id',$purchase->store_id)->country}} , {{$store->firstWhere('id',$purchase->store_id)->state}}<br>
    Phone: {{$store->firstWhere('id',$purchase->store_id)->mobile}}<br>
</td>
</tr>
</tr>
                                ...
                                <td colspan="3">
                                    <table cellspacing="0px" cellpadding="2px">
                                        ...
                                        <tr class="item">
                                            <td style="width:25%;">
                                            {{ $items->firstWhere('id', $p->item_id)->item_name ?? 'N/A' }}
                                            </td>
                                            <td style="width:10%; text-align:center;">
                                            {{$p->hsn_code}}
                                            </td>
