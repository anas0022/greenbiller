...
<head>
 ...
 <link rel="stylesheet" href="{{asset('admin-assets/css/invoice-template/datatable.css')}}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('home')}}" class="brand-logo">
                <img class="logo-abbr" src="{{asset('admin-assets/images/header_image/1700131278.png')}}" alt="">
                @foreach ($logo as $l )
               
                <img class="brand-title" src="{{asset('storage/'.$l->logo)}}" alt="">
                @endforeach
