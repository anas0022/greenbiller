                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <select id="" onchange="countryselecting()" name="store_id"
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{route('purchase_return_update')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span style="display:flex;">
                                                <input type="text" name="bill_no" class="form-control form-control-sm"
                                                    style=" " value="{{$purchase->bill_number}}">
                                            ...
                                            <div class="table table-responsive" style="width: 100%; color: #fff;">
                                                <table class="table table-hover table-bordered" style="width:100%"
                                                    ...
                                                    <tbody id="item-results">
                                                        ...
                                                        <form action="{{ route('purchase.return_post') }}" method="POST">
                                                            @csrf
                                                       

                                                                                                                <tr  style="background-color: {{ $pur->status == 1 ? 'rgba(167, 162, 162, 0.705)' : 'transparent' }}">
                                                                                                                    <input type="hidden" name="id[]" class="return_id" value="{{ $pur->id }}" disabled id="return_id_{{ $i }}">
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}"><input name="item_id[]" type="text"
                                                                                                                            id="item_id_{{$i}}"
                                                                                                                    ...
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}">
                                                                                                                    ...
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}"> <input name="purchase_price[]"
                                                                                                                    ...
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}"> <input name="discount_amt[]" id="discount_{{$i}}"
                                                                                                                            type="text" class="form-control form-control-sm"
                                                                                                                    ...
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}"> <input name="tax_amt[]" id="tax_amt_{{$i}}" type="text"
                                                                                                                            class="form-control form-control-sm"
                                                                                                                    ...
                                                                                                                    <td style="opacity: {{ $pur->status == 1 ? '0.2' : '1' }}"> <input name="total_amount[]" id="total_amount_{{$i}}"
                                                                                                                            type="text"
                                                                                                                            ...
                                                                                                                            <td style="
                                                                                                                            {{ $pur->status == 1 ? 'position: absolute; left: 50%; transform: translateX(-50%); border:none; ' : '' }}">
                                                                                                                     @if ($pur->status == 1)
                                                                                                                         <!-- 'Item Returned' positioned absolutely -->
                                                                                                                         <span class="btn  " style="font-size:18px; font-weight:600; color:black">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="purchase_note"
                                                        class="form-control">{{$purchase->purchase_note}}</textarea>
                                                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="discount_to_all_amt"
                            ...
                            class="form-control form-control-sm"
                            style="background-color: #ddd;font-size:18px !important;"
                            oninput="totalamtsum()" name="all_discount" readonly
                        ...
                        <input type="text" id="total_amt" name="grand_total"
                            ...
                            value="{{$purchase->grand_total}}">
                                ...
                                <div class="card-header">
                                    ...
                                    <a href="dashboard" class="btn btn-danger ">Close</a>
                                    <button name="save" type="submit" class="btn btn-primary">Print</button>
                                </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach(function (data) {
                    ...
                    htmlRows += '<td> <input name="discount_amt[]" id="discount_' + count + '" type="text" class="form-control form-control-sm" value="' + (data.discount ? data.discount : "00") + '"><select name="discount_type[]" id="item_discount_type_' + count + '" onchange="itemTotal('+count+')"><option value="">select</option><option value="percent">Percentage</option><option value="fixed">Fixed</option></select></td>';
...
<script>
  ...
  Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('purchase.return_post') }}", // URL to send the request to
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
