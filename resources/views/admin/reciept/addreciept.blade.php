                                ...
                                <div class="row g-4 mb-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="sale_prefix" id="bill_no" class="form-select selectpicker"
                                                onchange="billcheck()">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card bg-light">
                                                    <div class="card-body p-3">
                                                        ...
                                                        <input type="text" name="yet_to_pay" id="grand_total"
                                            ...
                                            <div class="col-12">
                                                <div class="card bg-danger bg-opacity-10">
                                                    <div class="card-body p-3">
                                                        ...
                                                        <input type="text" name="yet_to_pay" id="yet_to_pay"
                                ...
                                ">
                                    ...
                                    ">
                                            <input type="text" name="prefixs[]" class="form-control prefix-input"
                                                readonly style="flex: 1; margin-right: 5px;" value="{{ old('prefixs.0') }}">
                                            <button type="button" class="btn btn-danger shadow btn-xs sharp delete-prefix">
