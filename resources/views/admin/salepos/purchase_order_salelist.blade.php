                    ...
                    <div class="card" style="padding: 10px;">
                        <div>
                            <div class="card-footer" >
                                <h4 class="card-text d-inline"> Purchase Order List </h4>
                                <div style="padding: 10px;">

                                    <a href="{{route('add_Purchase_order_sale')}}"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="z-">
                                                        <a href="{{ route('invoice.purchase.sale', ['id'=>$item->id,'sale_type'=>$item->sales_type]) }}"
                                                            class="dropdown-item" type="submit">
                                                            <i class="fas fa-eye"></i> View Order
                                                        </a>

                                                        <a class="dropdown-item" href="{{route('create_purchase_order_sale_post',['id'=>$item->id])}}">
                                                            <i class="fas fa-pencil-alt"></i> Convert To  Sale
                                                        </a>
