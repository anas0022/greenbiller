                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('sale_edit') }}"
                                enctype="multipart/form-data">


                                @csrf
                                <input type="text" value="{{$sale->id}}" name="id" hidden>
                                <!-- models -->
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <select name="tax_id[]" id="taxid_{{ $i }}" class="form-control form-control-sm" onchange="calculatetax({{ $i }});">
                                                         <option value="">-select-</option>
                                                         <option value="{{ $tax->firstWhere('id', $sale->tax_id)->id }}">{{ $tax->firstWhere('id', $sale->tax_id)->taxname }}</option>
                                                         @foreach ($taxes as $u)
                                                             @if ($u->id !== $sale->tax_id)
                                                 ...
                                                 <td><input name="tax_amt[]" id="tax_amt_{{ $i }}" type="text" class="form-control form-control-sm" value="00" style="background-color: #ddd;"></td>
                                                 ...
                                                 <td>
                                                     <form action="{{ route('item_delete_salebill') }}" method="post">
                                                         ...
                                                         <button type="submit" onclick="deleteItem({{ $sale->id }})" class="btn btn-danger shadow btn-xs sharp">
