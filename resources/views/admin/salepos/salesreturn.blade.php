...
<body class="skin-blue layout-top-nav " style="height: auto" cz-shortcut-listen="true">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form class="form-horizontal"
                                enctype="multipart/form-data" action="{{route('sale_return_update')}}" method="POST">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group" data-toggle="tooltip" title=""
                                                        ...
                                                        <select class="form-control select2 select2-hidden-accessible"
                                                            ...
                                                            <option value="{{ $sale->store_id }}">
                                                                {{ $store->firstWhere('id', $sale->store_id)->store_name ?? 'N/A' }}
                                                            </option>
                                       ...
                                       {{--  <div class="col-md-2">
                                        ...
                                        <input type="hidden" name="id" id="" value="{{$sale->id}}"> 
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" data-toggle="tooltip"
                                                title="" placeholder="Invioce Number" id="sale_code"
                                                name="sale_code" value="{{$prefix}}/{{$code}}" readonly />
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" 
                                                title="" placeholder="Invioce Number" id="sale_code"
                                                name="returnsale_code" value="{{$saleCode}}" readonly />
                                        </div>
                                    </div>
                                    <script>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group" data-toggle="tooltip" title=""
                                                ...
                                                <input type="date" class="form-control ui-autocomplete-input"
                                                    name="sales_date" id="dateInput" value="{{ $sale->sales_date }}"
                                                    readonly />
                                        ...
                                        <div class="col-md-6" style="margin-bottom: 20px;">
                                            <div class="input-group" data-toggle="tooltip" title=""
                                                ...
                                                <input type="text" class="form-control ui-autocomplete-input"
                                                    ...
                                                    value="{{ $sale->reference_no }}" readonly />
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12"
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody
                                                            ...
                                                            @php
                                                                $i = 1;
                                                            @endphp
                                                      @if (!empty($sales_itemdata))
                                                      @foreach ($sales_itemdata as $sale)
                                                          <form action="{{ route('return_post') }}" method="POST">
                                                              @csrf
                                                              <tr style="background-color: {{ $sale->status == 1 ? 'rgba(167, 162, 162, 0.705)' : 'transparent' }}">
                                                                  <input type="hidden" name="id[]" class="return_id" value="{{ $sale->id }}" disabled id="return_id_{{ $i }}">
                                                  
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                  ...
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <input name="rate_inc_tax[]" id="rate_inc_tax_{{ $i }}" type="text" class="form-control form-control-sm" value="{{ $sale->rate_inclusive_tax }}" oninput="cal_division({{ $i }})">
                                                                  </td>
                                                  
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <input name="purchase_price[]" id="purchase_price_{{ $i }}" type="text" oninput="update_calculation({{ $i }})" class="form-control form-control-sm" value="{{ $sale->price_per_unit }}">
                                                                  </td>
                                                                  ...
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <select name="tax_id[]" id="taxid_{{ $i }}" class="form-control form-control-sm" onchange="calculatetax({{ $i }});">
                                                                          <option value="{{ $taxids->firstWhere('id', $sale->tax_id)->id }}">{{ $taxids->firstWhere('id', $sale->tax_id)->taxname }}</option>
                                                                          @foreach ($taxes as $u)
                                                                              @if ($u->id !== $sale->tax_id)
                                                                      ...
                                                                      <input type="text" id="taxInput_{{ $i }}" value="" hidden>
                                                                  </td>
                                                  
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <input name="tax_amt[]" id="tax_amt_{{ $i }}" type="text" class="form-control form-control-sm" value="{{ $sale->tax_amt }}" style="background-color: #ddd;">
                                                                  </td>
                                                  
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <input type="text" id="mrp_{{ $i }}" value="{{ $sale->mrp }}" name="mrp[]" class="form-control form-control-sm">
                                                                  </td>
                                                  
                                                                  <td style="opacity: {{ $sale->status == 1 ? '0.2' : '1' }}">
                                                                      <input name="total_amount[]" id="total_amount_{{ $i }}" type="text" class="form-control form-control-sm total" value="{{ $sale->total_cost }}" style="background-color: #ddd;" oninput="total_sum()">
                                                                  </td>
                                                  
                                                                  <td style="
                                                                    {{ $sale->status == 1 ? 'position: absolute; left: 50%; transform: translateX(-50%); border:none; ' : '' }}">
                                                             @if ($sale->status == 1)
                                                                 <!-- 'Item Returned' positioned absolutely -->
                                                                 <span class="btn btn-secondary btn-xs" style="font-size:18px; font-weight:600;">
                                                                    <i class="fa-solid fa-person-walking-arrow-loop-left"></i>  Item Returned
                                                                 </span>
                                                             @else
                                                                 <!-- Default button when status is not 1 -->
                                                                 <button type="button" onclick="return_item({{ $i }})" class="btn btn-danger shadow btn-xs sharp">
                                                  ...
                                                  @endif
                                                            ...
                                                            <input type="hidden" id="click_count_{{ $i }}" class="click_count" value="0" disabled>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 text-right">
                                            ...
                                            <input type="text" id="other_charges_amt" name="other_charge"
                                                class="form-control form-control-sm" readonly
                                                style="background-color: #ddd; font-size:18px !important; text-align:right"
                                                oninput="totalamtsum()" value="{{$othercharge}}">
                ...
                success: function(response) {
                    ...
                    response.forEach(function(test) {
                        ...
                        document.getElementById("ui-id-1").innerHTML = searchs +
                            '<li class="ui-menu-item" role="presentation"><a href="javascript:void(0)" onclick="additem(' +
                            test.id + ')" class="ui-corner-all" tabindex="-1" >' + test.item_name +
                            '[ ' + test.part_no + ']</a></li>';
    ...
    <script>
        function return_item(index) {
            var inputField = document.getElementById('return_id_' + index);

            // Enable the input field by removing the 'disabled' attribute
            inputField.removeAttribute('disabled');

            // Optionally, show a confirmation using SweetAlert
             Swal.fire({
                title: "Are you sure?",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('return_post') }}", // URL to send the request to
                        type: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: inputField.value // Send the item ID
                        },
                        success: function(response) {
                            Swal.fire({
                                title: "Item Returned!",
        ...
        if (result.isConfirmed) {
            ...
            location.reload();
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: "Error!",
                                text: "An error occurred while returning the item. Please try again.",
                                icon: "error",
                                confirmButtonText: "OK"
                            });
                        }
