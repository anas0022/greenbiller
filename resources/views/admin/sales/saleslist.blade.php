                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="z-">
                                                        ...
                                                        <a href="{{ route('invoice_sale.view', ['id'=>$item->id,'sale_type'=>$item->sales_type]) }}"
                                                            class="dropdown-item" type="submit">
                                                            <i class="fas fa-eye"></i> View Sale
                                                        </a>

                                                        <a class="dropdown-item" href="{{route('admin_saleitem_edit',['id'=>$item->id])}}"><i class="fas fa-pencil-alt"></i>
                                                            Edit</a>
                                                          
                                                        @if ($item->paid_amount == Null)
                                                            <a class="dropdown-item"
                                                                data-toggle="modal"
                                                                data-target="#cash-payments-modal" onclick="totals({{$item->total_qty}},{{$item->grand_total}},{{$item->id}})"><i
                                                                    class="fas fa-money-check-dollar"></i> Make Payments</a>
                                                        @else
                                                        <a class="dropdown-item"
                                                        href="{{route('payment.view',['id'=>$sale_pays])}}"><i
                                                              class="fas fa-money-check-dollar"></i> View Payments</a>
                                                                    ...
                                                                    @endif
                                                                          ...
                                                                          <a class="dropdown-item"
                                                                          href="{{route('sale.return',['id'=>$item->id])}}" style="color:red;"><i class="fa-solid fa-rotate-left" ></i> Sale Return</a>
