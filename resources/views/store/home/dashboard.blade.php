...
@section('content')
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadStockAlertItems() {
                $.ajax({
                    url: "{{ route('stockalertitem.store') }}", // Ensure this route is defined in your web.php
                    type: "GET",
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $.ajax({
                type: "GET",
                url: "{{ route('suppliercountall.store') }}",
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchRecentItems() {
                $.ajax({
                    type: "GET",
                    url: "{{ route('recentitem.store') }}", // Ensure this route is defined in your web.php
                    success: function(response) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchRecentSale() {
                $.ajax({
                    type: "GET",
                    url: "{{ route('salelatest.store') }}", // Ensure this route is defined in your web.php
                    success: function(response) {
  ...
  <td>${grandTotal ? `₹ ${grandTotal}` : ''}</td><!-- Conditionally show grand_total -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            $.ajax({
                type: "GET",
                url: "{{ route('customercountall.store') }}",
                success: function(response) {
                    let total = response;
    ...
    <script>
        async function fetchMonthlyReport() {
            const response = await fetch('/admin/monthly-report-store'); // Ensure the URL is correct
            if (!response.ok) {
   ...
   {{--  <script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('purchasecountall.store') }}",
                success: function(response) {
                    let total = response;
    ...
    <script>
        ...
        document.querySelector('button[name="week"]').addEventListener('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('purchaseweekcount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('purchase_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('supplierweekcount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('supplier_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('customerweekcount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('customer_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('expenceweeksum.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('expence').innerText = formatNumber(total);
                },
        ...
        document.querySelector('button[name="month"]').addEventListener('click', function() {
            $.ajax({
                type: "GET",
                url: "{{ route('expenseMonthlySum.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('expence').innerText = formatNumber(total);
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('saleMonthlySum.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('sale').innerText = formatNumber(total);
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('customerMonthlycount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('customer_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('supplierMonthlycount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('supplier_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('purchaseMonthlycount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('purchase_count').innerText = total;
                },
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('saleMonthlycount.store') }}",
                success: function(response) {
                    let total = response;
                    document.getElementById('sale_count').innerText = total;
                },
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelector('button[name="yearly"]').addEventListener('click', function() {
                $.ajax({
                    type: "GET",
                    url: "{{ route('expenseYearlySum.store') }}",
                    success: function(response) {
                        let total = response;
                        document.getElementById('expence').innerText = formatNumber(total);
                    },
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('saleYearlycount.store') }}",
                    success: function(response) {
                        let total = response;
                        document.getElementById('sale_count').innerText = total;
                    },
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('purchaseYearlycount.store') }}",
                    success: function(response) {
                        let total = response;
                        document.getElementById('purchase_count').innerText = total;
                    },
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('suplierYearlycount.store') }}",
                    success: function(response) {
                        let total = response;
                        document.getElementById('supplier_count').innerText = total;
                    },
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('customerYearlycount.store') }}",
                    success: function(response) {
                        let total = response;
                        document.getElementById('customer_count').innerText = total;
                    },
