...
<form id="altQtyForm">
    ...
    <input type="text" name="alt_unit" placeholder="Enter alt unit here" value="{{ $item->alt_unit }}">
    <button type="submit">Done</button>
</form>
...
@else
    {{ number_format(optional($item_alqty->firstWhere('id', $item->item_id))->alt_unit * $item->sales_qty) }} Litters
@endif
    @endif
