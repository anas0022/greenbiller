                        ...
                        <div>
                            <div class="card-footer" >
                                ...
                                <div style="padding: 10px;">
                                    ...
                                    <a href="{{route('add_extimate.store')}}"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="z-">
                                                        <a href="{{ route('invoice.sale.extimate.store', ['id'=>$item->id,'sale_type'=>$item->sales_type]) }}"
                                                            class="dropdown-item" type="submit">
                                                            <i class="fas fa-eye"></i> View Extimate
                                                        </a>

                                                        <a class="dropdown-item" href="{{route('extimate_sale_add.store',['id'=>$item->id])}}">
                                                            <i class="fas fa-pencil-alt"></i> Make Sale
                                                        </a>
