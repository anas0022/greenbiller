                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($item->paid_amount == Null || $item->paid_amount < $item->grand_total)
                                            ...
                                            @endif
                                            @if($item->paid_amount < $item->grand_total)
                                                @php
                                                    // Get the first ledger entry for the current sale
                                                    $ledgerEntry = $ledger->where('sale_id', $item->id)->first();
                                                @endphp
                                                @if($ledgerEntry && isset($ledgerEntry->id))
                                                    <a class="dropdown-item" href="{{ route('reciept.view', ['id' => $ledgerEntry->id]) }}">
                                                        <i class="fas fa-money-check-dollar"></i> View Payments
                                                    </a>
                                                @else
                                                    <p>No payment records available.</p> <!-- Debugging output -->
                                                @endif
                                            @endif
